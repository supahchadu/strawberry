//
//  FacebookButtonDesignView.swift
//  notefy
//
...
class FacebookButtonDesignView: UIButton {
    override func awakeFromNib() {
        ...
        // layer.cornerRadius = 5.0 // Making the edges smooth or curve for the button.
        imageView?.contentMode = .ScaleAspectFit
        
    }
    // Overriding it make not use of the inherited framesize of the original view.
